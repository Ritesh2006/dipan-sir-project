import "./chunk-VIU7LPZF.js";
import {
  RecordingStatus
} from "./chunk-ZUI6IPVY.js";
import {
  Capacitor,
  WebPlugin,
  registerPlugin
...
var Filesystem = registerPlugin("Filesystem", {
  web: () => import("./web-RPAFZI3S.js").then((m) => new m.FilesystemWeb())
});
f();
    ...
    this.pendingResult = new Promise((resolve, reject) => {
      ...
      this.mediaRecorder.onstop = async () => {
        ...
        if (options != null) {
          ...
          recordDataBase64 = await _VoiceRecorderImpl.blobToBase64(blobVoiceRecording);
        }
...
//# sourceMappingURL=web-OT7W5KCS.js.map
